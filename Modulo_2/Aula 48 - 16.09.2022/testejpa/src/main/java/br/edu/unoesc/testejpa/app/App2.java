...
public class App2 {
	...
	public static void main(String[] args) {
		...
		jpql = "SELECT p FROM Pessoa p WHERE p.departamento = :departamento";
		pessoas = em.createQuery(jpql, Pessoa.class)
		...
		jpql = "SELECT p.salario FROM Pessoa p WHERE p.id = :id";
