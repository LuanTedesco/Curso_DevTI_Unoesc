...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		...
		repositorio.saveAll( Arrays.asList(
				new Funcionario(null, "Sicrano", 2, new BigDecimal("42.42"), LocalDate.of(2001, 12, 28)),
				new Funcionario(null, "Mecanica", 3, new BigDecimal("666"), LocalDate.of(1975, 6, 6)),
				new Funcionario(null, "Deide Costa", 4, new BigDecimal("4999.99"), LocalDate.of(1985, 8, 17)),
				new Funcionario(null, "Fabiano Chu Passeios", 0, new BigDecimal("123.45"), LocalDate.of(2000, 5, 10)),
				new Funcionario(null, "João das Graças", 3, new BigDecimal("666"), LocalDate.of(1975, 6, 6))
			));
	}
	...
	public Funcionario buscarPorId(Long id) {
		return repositorio.findById(id).orElse(new Funcionario(id, null, 0, null, null));					      
	}
	...
	@Override
	public Page<Funcionario> buscaPaginadaPorTitulo(String nome, Integer salario, Integer tamPagina, String campo,
			String direcao) {
		PageRequest reqPagina = PageRequest.of(salario,tamPagina,Sort.by(Direction.valueOf(direcao),campo));
